...
# =============================================
BOT_TOKEN = "8907437855:AAHZDxaGe2mvZyXSa1kwGl-4rg_u08yQZmk'"         # @BotFather থেকে নাও
ANTHROPIC_KEY = "2dba1986cb839c95d771ed61a1bcb72e"
"  # console.anthropic.com থেকে নাও
...
async def message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        response = client.messages.create(
            ...
            messages=[{"role": "user", "content": f"এই website সম্পর্কে সব তথ্য দাও: {text}"}]
        )
    ...
    if query.data == "home":
        ...
        try:
            response = client.messages.create(
                ...
                max_tokens=1500,
                system=SYSTEM_PROMPT,
                messages=[{"role": "user", "content": f"এই website সম্পর্কে তথ্য দাও: {site}"}]
            )
            result = response.content[0].text
        except Exception as e:
            result = f"❌ Error: {str(e)}"
